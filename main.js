...
const DEBUG_NO_OF_WIN_BETS = 0 // if win all split4 double4 = 8, win all split4 double3 = 7
...
function playBlackjack() {
    ...
    if (firstFiveBets) {
        ...
        let noOfWinBets = Math.floor(winnablePot / betSize)
        if (DEBUG) {
